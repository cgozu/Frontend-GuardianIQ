<script>
import createAndEditComponent from "@/buyContext/shared/components/create-and-edit.component.vue";
...
<template>
  <create-and-edit-component :entity="item" :visible="visible" entityName="Tutorial" @canceled="canceledEventHandler"
